import { useHumanizeMutation } from "@/api/services/humanizer";
...
export default function HumanizerScreen() {
  ...
  const { mutateAsync: humanize } = useHumanizeMutation();
  ...
  const handleHumanize = async () => {
    ...
    try {
      ...
      const response = await humanize(currentInput);
      ...
      >
        ...
        >
          ...
          <View style={{ flex: 1, marginLeft: 12 }}>
            ...
            >
              Transform your text to sound more human
            </Text>
          </View>
        </View>
        ...
        {currentOutput ? (
          ...
          !isLoading && (
            <EmptyState
              icon="✨"
              title="Ready"
              message="Tap Humanize to generate a result"
            />
          )
        )}
      </ScrollView>
